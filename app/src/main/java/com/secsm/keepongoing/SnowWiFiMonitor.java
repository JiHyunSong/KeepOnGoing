...
/*
        ...
        if (strAction.equals(ConnectivityManager.CONNECTIVITY_ACTION)) {
            ...
            Log.i("", "~!~" + activeNetInfo.getTypeName());
            Log.i("", "~!~" + activeNetInfo.getState().toString());
            m_OnChangeNetworkStatusListener.OnChanged(mobNetInfo.getType());
            m_OnChangeNetworkStatusListener.OnChanged(activeNetInfo.getType());
        }*/
